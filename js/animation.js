...
function initialize()
{
    mapPlague = new google.maps.Map(document.getElementById('map'),
        {
            center: {lat: 46.75, lng: 13.87},
            zoom: 9,
            mapTypeControl: false,
    ...
    var CARTOCSS = [
        'Map {',
        '-torque-time-attribute: "Jahr";',
        '-torque-aggregation-function: "count(cartodb_id)";',
        '-torque-frame-count: 388;',
    ...
    var torqueLayer = new torque.GMapsTorqueLayer({
        user       : 'Evnica@gmail.com',
        table      : '/tables/pest.csv',
        cartocss: CARTOCSS,
        map: mapPlague
    });

    torqueLayer.setMap(mapPlague);
    init_slider(torqueLayer);
    torqueLayer.play();
}

function initSlider(torqueLayer)
{
    var time = $('#torque-time');
